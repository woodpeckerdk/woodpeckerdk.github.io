...
![image-20240501192916417](picture/基因矩阵转置文件格式gmt/image-20240501192916417.png)
...
首先我们从[GESA](https://www.gsea-msigdb.org/gsea/downloads.jsp)的官网上，下载一个gmt文件。这里以KEGG的gmt文件为例，其他gmt文件的读取方法一样。

![image-20240501194223905](picture/基因矩阵转置文件格式gmt/image-20240501194223905.png)

c2.cp.kegg.v7.0.symbols.gmt这个文件里面保存的是基因的名字

![image-20240501194312112](picture/基因矩阵转置文件格式gmt/image-20240501194312112.png)
...
> ![image-20240501194721788](picture/基因矩阵转置文件格式gmt/image-20240501194721788.png)
...
![image-20240501195018153](picture/基因矩阵转置文件格式gmt/image-20240501195018153.png)
